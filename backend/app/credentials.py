...
class CredentialBroker:
    """Issues opaque, short-lived, least-privilege credentials."""
    ...
    def validate(self, credential_id: str, agent_id: str, tool: str, required_scope: str, token: str | None = None) -> bool:
        ...
        if row is None or row["agent_id"] != agent_id or row["tool"] != tool:
            return False
